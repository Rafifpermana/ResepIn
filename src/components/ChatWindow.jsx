...
const ChatWindow = ({ messages }) => {
  return (
    <div className="w-full bg-white space-y-4 overflow-y-auto">
      {messages.length === 0 ? (
        ...
        <div className="space-y-4 p-4 sm:p-6 h-[70vh] scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-gray-100">
